# Heavy-Hex (3,3) Surface Code — 디코더 프로젝트 (개정판)
...
> 이 문서는 기존 README.md의 전체 내용에 **모델 축(`--model {cnn,gnn}`)과
> 코드 축(`--code {heavyhex,surface}`)** 등 신규 기능을 통합한 개정판이야.
> 기존 README.md는 그대로 남아 있어.
